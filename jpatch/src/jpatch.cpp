...
#define BLKSZE 4096
#define EXI_SEK  5      // Error seeking file
#define EXI_LRG  6      // Error on 64-bit number
#define EXI_RED  7      // Error reading file
#define EXI_WRI  8      // Error writing file
...
int main(int aiArgCnt, char *acArg[])
{
  ...
  if ((giVerbse>0) || (lcHlp == 'h') || (aiArgCnt - liOptArgCnt < 3)) {
    fprintf(stddbg, "JPATCH - Jojo's binary patch v0.8 (Beta) September 2011\n") ;
    fprintf(stddbg, "Copyright (C) 2002-2011 Joris Heirbaut (http://sourceforge.net/projects/jojodiff/)\n");
    fprintf(stddbg, "\n") ;
